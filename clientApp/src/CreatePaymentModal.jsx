...
export default function CreatePaymentModal({ invoices, addPayment, updateInvoice}) {
	...
	return (
		<div>
			<Button variant="contained" disabled={!invoices || !invoices.length || !invoices.some((i) => i.status === 'Pending')} className="add-button" onClick={handleOpen}>Make a Payment</Button>
			<Modal
				open={open}
				onClose={handleClose}
